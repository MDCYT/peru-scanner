...
function getMockCameras(): Camera[] {
  return [
    ...
    {
      id: '6',
      nombre: 'Cámara Av. José Faustino Sanchez Carrión - Jesus Maria',
    ...
    // Cámaras públicas de SkylineWebcams
    {
      id: '9',
    ...
    },
    {
      ...
      direccion: 'Playa Señoritas, Punta Hermosa',
      latitud: -12.3333,
      longitud: -76.8167,
      estado: 'Operativo',
      tipo: 'Vigilancia',
    ...
    },
    {
      ...
      direccion: 'Playa Caballeros, Punta Hermosa',
      latitud: -12.3361,
      longitud: -76.8194,
      estado: 'Operativo',
      tipo: 'Vigilancia',
    ...
    },
    {
      ...
      direccion: 'Malecón Grau, Chorrillos',
      latitud: -12.1742,
      longitud: -77.0158,
      estado: 'Operativo',
      tipo: 'Vigilancia',
